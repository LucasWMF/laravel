...
Route::get('/proprietario/listar', [App\Http\Controllers\ProprietarioController::class, 'list'])->name('proprietario-listar');
...
Route::get('/anuncio/listar', [App\Http\Controllers\AnuncioController::class, 'list'])->name('anuncio-listar');
